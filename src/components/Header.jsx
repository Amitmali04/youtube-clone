  ...
  return (
    <div className="static top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-gray-100 dark:bg-black">
      ...
      <div className="group flex items-center">
          <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-black-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
          ...
          <div className="ml-5 flex items-center justify-center h-10 w-10 rounded-full hover:bg-[#303030]/[0.6]">
            <MdKeyboardVoice className="text-black text-xl cursor-pointer" />
          </div>
        </div>
