  ...
  return (
    ...
    <div className="flex flex-col mb-8">
      <div className="relative h-48 md:h-40 rounded-xl overflow-hidden">
        <img
          className="h-full w-full object-cover" src={video?.thumbnails[0]?.url} alt="VideoImage"
        />
      ...
      <div className="flex text-black mt-3">
        <div className="flex items-start">
          <div className="flex h-9 w-9 rounded-full overflow-hidden">
            <img className="h-full w-full object-cover" src={video?.author?.avatar[0]?.url} alt="AuthImage"
            />
          </div>
        </div>
